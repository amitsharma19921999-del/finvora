...
export default function Portfolio() {
  ...
  const columns = [
    ...
    },
    {
      ...
      // Deep-link to the terminal with THIS holding preselected and the ticket on
      // SELL — otherwise the user lands on whatever instrument happens to be first.
      render: (h) => (
        <Link className="btn btn-sm btn-sell tap" to={`/app/trade?instrument=${h.instrument_id}&side=SELL`}>Sell</Link>
      ),
    },
  ];
